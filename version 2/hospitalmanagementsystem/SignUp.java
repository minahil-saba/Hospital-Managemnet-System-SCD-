    ...
    private void initComponents() {
        ...
        passwordlabelLayout.setVerticalGroup(
            ...
            .addGroup(passwordlabelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(elabel, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(passwordlabelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel2.add(passwordlabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 0, 300, 490));
    ...
    if (validInput) {
        ...
        new Thread(() -> {
            try {
                ...
                pst.setString(4, roleSelected);

                // Execute the query without assigning it to a variable
                pst.executeUpdate();

                // Close PreparedStatement
                pst.close();   // Perform UI updates on the Event Dispatch Thread
